...
"""
Inspired by: https://github.com/zzzeek/sqlalchemy/blob/master/examples/dogpile_caching/caching_query.py
 ...
 * using_cache - a query option that establishes caching
   parameters on a Query
 * using_relationship_cache - a variant of using_cache which is specific
...
class CachingQuery(Query):
    ...
    of a using_cache or using_relationship_cache object.   Each of these objects
    ...
    The using_cache and using_relationship_cache mapper options below represent
    ...
    def _get_cache_plus_key(self):
        ...
        dogpile_region = self._cache_region.region
...
class using_cache(MapperOption):
    """Specifies that a Query should load results from a cache."""

    propagate_to_loaders = False

    def __init__(self, region, cache_key=None):
        """Construct a new using_cache.
...
class using_relationship_cache(MapperOption):
    """Specifies that a Query as called within a "lazy load"
       should load results from a cache."""

    propagate_to_loaders = True

    def __init__(self, attribute, region, cache_key=None):
        """Construct a new using_relationship_cache.
    ...
    def and_(self, option):
        """Chain another using_relationship_cache option to this one.

        While many using_relationship_cache objects can be specified on a single
